...
srun --label --ntasks-per-node=1 --time=2500 --mem-per-cpu=5120 --gres=gpu:8 --cpus-per-task 80 --nodes=1 --pty python distributed_mlm_task.py --world_size 8 --seed 5431916812 --epochs 50 --emsize 768 --nhid 3072  --nlayers 12 --nhead 12 --save-vocab squad_30k_vocab_cls_sep.pt --dataset EnWik9 --lr 6  --bptt 128  --batch_size 56 --clip 0.1 --log-interval 600
