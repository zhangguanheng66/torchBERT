...
srun --label --pty python  distributed_mlm_task.py --world_size 8 --parallel DDP --seed 2514683 --epochs 2 --emsize 128 --nhid 512  --nlayers 2 --nhead 8 --save-vocab squad_30k_vocab_cls_sep.pt --dataset WikiText2  --lr 2  --bptt 128  --log-interval 10  --batch_size 56
